...
public:
	...
	ParticleEmitterSettings() :
		...
		Shape(EmitterSpawnShape::SPHERE),
		SpawnBasedVelocityEnabled(false),
		MinSpawnBasedVelocity(0),
		MaxSpawnBasedVelocity(0){}
	...
	XMFLOAT4 Color;
	EmitterSpawnShape Shape;
	bool SpawnBasedVelocityEnabled;
	float MinSpawnBasedVelocity;
	float MaxSpawnBasedVelocity;
};
...
public:
	...
	void EnableSpawnBasedVelocity(bool enabled, float min, float max) { m_Settings.SpawnBasedVelocityEnabled = enabled; m_Settings.MinSpawnBasedVelocity = min; m_Settings.MaxSpawnBasedVelocity = max; };
	void Burst(const GameContext &gameContext);
	...
	void SetSpawnShape(EmitterSpawnShape shape) { m_Settings.Shape = shape; }
