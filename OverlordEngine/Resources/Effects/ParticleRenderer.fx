...
void MainGS(point VS_DATA vertex[1], inout TriangleStream<GS_DATA> triStream)
{
	...
	topLeft = float3(-size * 0.5f, -size * 0.5f, 0);
	topRight = float3(size * 0.5f, -size * 0.5f, 0);
	bottomLeft = float3(-size * 0.5f, size * 0.5f, 0);
	bottomRight = float3(size * 0.5f, size * 0.5f, 0);
	...
	CreateVertex(triStream,origin + bottomLeft, float2(0,1), vertex[0].Color, uvRotation);
	CreateVertex(triStream,origin + topLeft, float2(0,0), vertex[0].Color, uvRotation);
	CreateVertex(triStream,origin + bottomRight, float2(1,1), vertex[0].Color, uvRotation);
	CreateVertex(triStream,origin + topRight, float2(1,0), vertex[0].Color, uvRotation);
}
